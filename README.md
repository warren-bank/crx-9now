### [9now](https://github.com/warren-bank/crx-9now/tree/webmonkey-userscript/es5)

[Userscript](https://github.com/warren-bank/crx-9now/raw/webmonkey-userscript/es5/webmonkey-userscript/9now.user.js) to run in:
...
Its purpose is to:
* redirect embedded videos from [9now.com.au](https://www.9now.com.au/) to an external player
